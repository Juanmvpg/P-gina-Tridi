...
files.forEach(file => {
  ...
  if (fs.existsSync(filePath)) {
    ...
    const envs = {
      ...
      'URL_DRIVE_GALERIA': process.env.URL_DRIVE_GALERIA || 'https://drive.google.com/drive/folders/TU_CARPETA_DE_GALERIA',
      'URL_SPREADSHEET': process.env.URL_SPREADSHEET || 'https://docs.google.com/spreadsheets/d/1RfJCp_vugDdTl-4lDKEkuZvNUWEKyX8uSibBxj2gDig/export?format=csv',
      ...
      'URL_KAHOOT': process.env.URL_KAHOOT || 'https://kahoot.it/',
      'URL_QUIZIZZ': process.env.URL_QUIZIZZ || 'https://quizizz.com/',
      'URL_FILMINAS_COLEGIO': process.env.URL_FILMINAS_COLEGIO || 'https://canva.link/kuge1m3si5tnzl6'
    };
